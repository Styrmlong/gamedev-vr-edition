...
public class EventSystem : MonoBehaviour
{
    ...
    //This event exists explicitly for testing
    public event Action<int> onTestEventTrigger;

    //This event trigger exist explicitly for testing
    public void TestEventTrigger(int id)
    {
        if (onTestEventTrigger != null)
        {
            onTestEventTrigger(id);
        }
    }
}
